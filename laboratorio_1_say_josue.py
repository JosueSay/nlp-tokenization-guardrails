...
TEXTOS_DE_PRUEBA = [
    "Hola mundo mi correo es unknow@correo.com.",
    "Quiero llamar al +502 12345678.",
    "Este repositorio esta en https://github.com/JosueSay/nlp-tokenization-guardrails.git.",
    "Mi api key de claude es sdk-123456789abc.",
    "Hice una transferencia para mi DPI 228011234554321."
]
